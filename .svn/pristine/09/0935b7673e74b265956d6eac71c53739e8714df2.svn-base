...
namespace MyUtility
{
    public class StringCommon
    {
        ...
        {
            var rd = new Random();
            var transId = DateTime.Now.ToString() + DateTime.Now.Millisecond.ToString();
    ...
    "\u00C1", "\u00C0"
        ...
        {
            return string.IsNullOrEmpty(strUnicode) ? string.Empty : strUnicode.Replace(@"""", string.Empty).Replace(@"'", string.Empty);
        }
