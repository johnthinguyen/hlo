...
namespace MyUtility
{
    public static class FileExtension
    {
		...
		public static DataTable CsvFileToDataTable(string fileName)
		{
			// Kiem tra file ton tai hoac khong phai csv
			if (!System.IO.File.Exists(fileName) || !Path.GetExtension(fileName).Equals(".csv"))
			{
				return null;
			}
